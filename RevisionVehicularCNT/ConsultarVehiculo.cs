...
{
    public partial class ConsultarVehiculo : MetroForm
    {
        public ConsultarVehiculo(String Documento)
        {
            InitializeComponent();
        ...
        private void buscarlictotal(String patente)
        {
            ...
            String busqueda = "select * from vehiculo where patente like '" + patente + "%' ; ";
